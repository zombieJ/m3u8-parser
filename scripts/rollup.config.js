...
const options = {
  ...
  primedPlugins(defaults) {
    ...
    defaults.dataFiles = dataFiles({
      expecteds: {
        include: "test/fixtures/integration/*.js",
        transform: "js",
        extensions: false,
      },
      manifests: {
        include: "test/fixtures/integration/*.m3u8",
        transform: "string",
        extensions: false,
      },
    });
  ...
  // Build in dist as `dist/m3u8-parser.cjs.js` & `dist/m3u8-parser.es.js`
  distName: "m3u8-parser",
};
